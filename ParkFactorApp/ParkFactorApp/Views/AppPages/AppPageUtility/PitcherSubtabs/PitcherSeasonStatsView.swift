...
struct PitcherSeasonStatsView: View {
    var player: Player
    ...
    var body: some View {
        ZStack {
            ...
            ScrollView {
                VStack {
                    PitcherBasicStatsView(pitchingStatsHelper: pitchingStatsHelper)
                        .padding(.bottom, 10)
                    PitcherAdvancedStatsView(pitchingStatsHelper: pitchingStatsHelper)
                        .padding(.bottom, 10)
                    PitcherPitchArsenalStatsView(pitchingStatsHelper: pitchingStatsHelper)
                        .padding(.bottom, 10)
                    PitcherPercentilesStatsView(player: player)
                        .padding(.bottom, 10)
                }
                .padding(20)
            }
