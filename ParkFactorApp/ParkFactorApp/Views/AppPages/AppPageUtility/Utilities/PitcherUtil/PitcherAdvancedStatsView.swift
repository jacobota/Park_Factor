    ...
    var body: some View {
        VStack {
            ...
            LazyVGrid(columns: Array(repeating: GridItem(.flexible()), count: 5), spacing: 5) {
                ...
                Button(action: {
                    selectedStat = "pitcher_kminusbbpercent"
                }) {
                    Text("K-BB%")
                        .font(.parkFactorFontSmallText)
                        .foregroundColor(Color.gray)
                ...
                Button(action: {
                    selectedStat = "pitcher_gbpercent"
                }) {
                    Text("GB%")
                        .font(.parkFactorFontSmallText)
                        .foregroundColor(Color.gray)
