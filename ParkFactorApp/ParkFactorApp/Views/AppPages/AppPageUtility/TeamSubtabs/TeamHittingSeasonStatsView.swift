//
//  TeamHittingSeasonStatsView.swift
//  ParkFactorApp
//
...
struct TeamHittingSeasonStatsView: View {
    ...
    var body: some View {
        ZStack {
            ...
            ScrollView {
                VStack {
                    TeamHittingDisplayStatsView(teamStats: teamStats)
                }
                .padding(20)
            }
        }
