...
struct HitterVisualsStatsView: View {
    var player: Player
    ...
    var body: some View {
        ZStack {
            ...
            ScrollView {
                VStack {
                    HitterSprayChartView(player: player, teamAbbr: getTeamAbbr())
                }
                .padding(20)
            }
        }
    ...
    private func getTeamAbbr() -> String {
